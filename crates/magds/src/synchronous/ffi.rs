...
#[no_mangle]
unsafe extern "C" fn magds_classification_accuracy(
    name_ptr: *const i8,
    train_file_ptr: *const i8,
    test_file_ptr: *const i8,
    target_ptr: *const i8,
...
#[no_mangle]
unsafe extern "C" fn magds_regression_rmse(
    name_ptr: *const i8,
    train_file_ptr: *const i8,
    test_file_ptr: *const i8,
    target_ptr: *const i8,
...
#[no_mangle]
unsafe extern "C" fn magds_regression_nrmse(
    name_ptr: *const i8,
    train_file_ptr: *const i8,
    test_file_ptr: *const i8,
    target_ptr: *const i8,
...
#[no_mangle]
unsafe extern "C" fn magds_regression_rmsp(
    name_ptr: *const i8,
    train_file_ptr: *const i8,
    test_file_ptr: *const i8,
    target_ptr: *const i8,
...
#[no_mangle]
unsafe extern "C" fn magds_regression_mae(
    name_ptr: *const i8,
    train_file_ptr: *const i8,
    test_file_ptr: *const i8,
    target_ptr: *const i8,
