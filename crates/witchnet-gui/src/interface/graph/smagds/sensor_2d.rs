...
use crate::{
    resources::{
        smagds::{ SMAGDSPositions, SENSOR_TEXT_CUTOFF },
    ...
    if settings.show {
        for i in 1..no_elements {
            ...
            let from_element = {
                ...
                point = smagds_positions::rotate_point_around_origin(point, first_neuron_pos, angle);
                [point.0, point.1]
            };
            let to_element = {
                let mut point = (second_neuron_pos.0 - neuron_size, second_neuron_pos.1);
                point = smagds_positions::rotate_point_around_origin(point, second_neuron_pos, angle);
                [point.0, point.1]
            };
            ...
            if settings.show_connector && settings.show {
                ...
                if settings.show_text {
                    let from_element = {
                        ...
                        point = smagds_positions::rotate_point_around_origin(
